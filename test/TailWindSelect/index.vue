<template>
  <div class="TailWindSelect">
    <section class="flex justify-center bg-gradient-to-t from-green-700">
      <select class="cursor-wait bg-red-400">
        <option>Yes</option>
        <option>No</option>
        <option>Maybe</option>
      </select>
    ...
    <section class="mt-6 bg-gradient-to-b from-black">
      <div
